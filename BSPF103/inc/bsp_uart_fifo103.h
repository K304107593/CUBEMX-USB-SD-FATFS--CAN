/************************************************************************** 
 * 模块名称 : 串口中断+FIFO驱动模块
 * FilePath: \CUBEMX USB+SD+FATFS +CAN\BSPF103\inc\bsp_uart_fifo103.h
 * Date: 2021-08-17 22:08:11
 * LastEditTime: 2021-12-09 17:37:39
 * 说     明: 头文件
 **************************************************************************/
...
#define	UART1_FIFO_EN	1		//使用串口来发送调试报告
...
void USART_Printf(uint8_t UsartPort,const char *fmt, ...);//实现调试打印
